...
CODE_FUNCTION_WITHOUT_ARGS(INT2FLOATS)
CODE_FUNCTION_WITHOUT_ARGS(FLOAT2INTS)
CODE_FUNCTION_WITHOUT_ARGS(INT2CHARS)
...
CODE_FUNCTION_WITHOUT_ARGS(ADDS)
CODE_FUNCTION_WITHOUT_ARGS(SUBS)
CODE_FUNCTION_WITHOUT_ARGS(MULS)
CODE_FUNCTION_WITHOUT_ARGS(DIVS)
